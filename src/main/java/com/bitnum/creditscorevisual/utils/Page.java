...
import com.bitnum.creditscorevisual.config.Global;
...
public class Page<T> {
	...
	public String toString() {
		...
		sb.append("<div class=\"box-footer clearfix\"><ul class=\"pagination pagination-sm no-margin pull-right\">");
		...
		if (pageNo == last) {
			sb.append("<li class=\"disabled\"><a style=\"margin-right:1px;\" href=\"javascript:\">下一页 &#187;</a></li>\n");
		} else {
			sb.append("<li><a style=\"margin-right:1px;\" href=\"javascript:\" onclick=\""+funcName+"("+next+","+pageSize+",'"+funcParam+"');\">"
					+ "下一页 &#187;</a></li>\n");
		}

		sb.append("<li class=\"disabled controls\"><a href=\"javascript:\">第 ");
		sb.append("<input style=\"border:0.5px solid #ddd;\" type=\"text\" value=\""+pageNo+"\" onkeypress=\"var e=window.event||event;var c=e.keyCode||e.which;if(c==13)");
		sb.append(funcName+"(this.value,"+pageSize+",'"+funcParam+"');\" onclick=\"this.select();\"/>页,每页 ");
		sb.append("<input style=\"border:0.5px solid #ddd;\" type=\"text\" value=\""+pageSize+"\" onkeypress=\"var e=window.event||event;var c=e.keyCode||e.which;if(c==13)");
